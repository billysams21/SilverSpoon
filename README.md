...
> **Note:** Currently, this tool supports `fuckingfast.co` links and `filecrypt.cc` containers (which extract to fuckingfast links). Support for other hosts may be added in the future.
